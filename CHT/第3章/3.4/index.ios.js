      ...
      <View style={styles.flex}>
        <View style={[styles.flexDirection, styles.inputHeight]}>
          ...
          <View style={styles.btn}>
            <Text style={styles.search} onPress={this.hide.bind(this, this.state.value)}>搜尋</Text>
          </View>
        </View>
        {this.state.show?
          <View style={[styles.result]}>
            <Text onPress={this.hide.bind(this, this.state.value + '莊')} 
                  style={styles.item} numberOfLines={1}>{this.state.value}莊</Text>
            <Text onPress={this.hide.bind(this, this.state.value + '園街')}
                  style={styles.item} numberOfLines={1}>{this.state.value}園街</Text>
            <Text onPress={this.hide.bind(this, 80 + this.state.value + '綜合商店')} 
                  style={styles.item} numberOfLines={1}>80{this.state.value}綜合商店</Text>
            ...
            <Text onPress={this.hide.bind(this, '楊林' + this.state.value + '園')} 
                  style={styles.item} numberOfLines={1}>楊林{this.state.value}</Text>
          </View>
          : null
        }
      </View>
